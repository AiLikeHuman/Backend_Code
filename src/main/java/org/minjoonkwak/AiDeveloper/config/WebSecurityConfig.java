    ...
    public class WebSecurityConfig {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            return http
                    ...
                    .csrf().disable()
                    .authorizeRequests()
                    .requestMatchers("/", "/login", "/api/login", "/api/signup", "/signup", "/user", "/index", "/css/**", "/js/**", "/images/**", "/oauth/**").permitAll()
        ...
        public CorsConfigurationSource corsConfigurationSource() {
            ...
            configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080", "http://127.0.0.1:5500", "http://aitravelfriend-env.eba-3npuxzum.ap-south-1.elasticbeanstalk.com")); // 허용할 도메인 설정
